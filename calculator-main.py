...
def plotAtXy(graph, x, y, appendLetter):
    ...
    graph[y][x] = graph[y][
                      x] + appendLetter  # y and x are unfefined/None, so it does graph[None][None] oh so error is in 190
...
def operationTwoLists(list1, list2, operation):
    ...
    for something in range(0, len(list1)):
        if operation == '+':
            ...
            raise ValueError("Invalid operation: "+str(operation)+". Can only be - + * or /.")
    return output
# base matrice ?
...
def help(one):
  if one=='1':
    ...
    print("                                                The point at X, Y on graph `graph` (a text graph) is changed")
    print("                                                to the letter appendLetter.")
    print("actualPlotAtXy(graph, x, y, appendLetter)       This is the one you should use, since it has bug fixes.")
    print("                                                Basically plotAtXy but better.")
    print("allPointsBetween(x1, y1, x2, y2)                This will get all points in between the coordinates x1, y1 and x2, y2.")
    print("allPointsBetween_float(x1, y1, x2, y2, accuracy)Difference: It gets all the points in between x1, y1, x2, y2 but it allows decimals.")
    print("                                                So you can specify an accuracy.")
    ...
    print("accuracy=4, appendLetter='*')                     Use mode='integer' & specify a accuracy. If you")
    print("                                                  want to know what appendLetter is, check plotAtXy's docs on page 1.")
    print("plotFunction(func_rule,                           Func_rule is the rule the function follows, e.g. 'f(x) = x + 1'.")
    print("   rangestart, rangeend,                          Rangestart and rangeend are the y-values you want to plot on the graph to and fro; like")
    print("                                                  -100, 100.")
    print("   appendLetter='*'                               < See plotAtXy for definition of appendLetter.")
    print("Thats all!")
  elif one=='set-theory':
    ...
    print("   [4,5,6],")
    print("   [7,8,9] ]")
    print("operationTwoLists(list1, list2, operation)        Preform a operation on two matrices.")
    print("operationMatrices(matrice1, matrice2, operation)  I forgor what this does if you really need it then ask me in a comment")
    print("negativeMatrice(matrice1)                         Makes all values in a matrice negative.")
    print("determinant2x2Matrix(matrice1)                    Get a determinant of a 2x2 matrix.")
    ...
    print("      I forgor what this does, but if you really need it ask me in a comment.")
    print("boxPlot(graph_array, outputType='array')")
    print("      graph_array: List of values")
    print("      outputType: the type of output you want (JSON for JSON or 'array' for list).")
  elif one == 'desm':
    ...
    print("tcsv_conv((1,2),(3,4))  Convert a list to CSV. Raises TypeError if only one row is given.")
